...
export default function Display() {
  ...
  return (
    <>
    <h1 className="head">CROPFETCH</h1>
    <div className='bg'><h1 className='about text-6xl pb-40'>Crop Recommendation System With TensorFlow</h1></div>
    <div className="stats mt-20 mb-20">
      <div className="nums bg-green-500">
        <div className="tcases text-white common"><h1>2200</h1><div className="comp">Test Cases</div></div>
        <div className="accuracy text-white common"><h1>95%</h1><div className="comp">Accuracy</div></div>
        <div className="time text-white common"><h1>2sec</h1><div className="comp">Max. Time</div></div>
      </div>
    </div>
    <div className="components flex flex-col items-center">
      <div className='text-7xl p-10 w-full text-center'>Components</div>
      <div className="frontend self-start h-96 text-5xl w-full bg-slate-900 text-white">
        FrontEnd:
        <div className="comps1 my-10 gap-10 absolute z-10 w-[45rem]">
			<Card img = {react} name = "REACTJS"></Card>
			<Card img = {tcss} name = "TAILWINDCSS"></Card>
		</div>

      </div>
      <div className="backend self-start h-96 text-5xl w-full bg-slate-500">
        BackEnd:
        <div className="comps2 gap-10 absolute z-10 my-10">
          <Card img = {flask} name = "FLASK"></Card>
          <Card img = {lg} name = "Logistic Regression"></Card>
        </div>
      </div>
      <div className="hardware self-start h-96 w-full text-5xl bg-slate-900 text-white">
        HardWare:
        <div className="comps3 absolute z-10 my-10">
      ...
      <div className="data w-full flex flex-col items-center h-48 m-12">
		<h1 className="params text-7xl">Parameters</h1>
      <section className="p-6 my-6 dark:bg-gray-800 dark:text-gray-100 w-full ">
	<div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
      ...
      <div className="buttons flex justify-center items-end h-56 w-full gap-6 m-20">
	  	<button className="btn-donate m-6" onClick={()=>{fetchData()}}>
    		Get Conditions
			<img src={cloud} alt="" />
       </button>
        <button className='plant m-6'>Get Crop
